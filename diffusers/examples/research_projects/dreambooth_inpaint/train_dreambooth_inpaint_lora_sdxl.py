...
def main(args):
    ...
    # # For inpainting, the UNet has 5 additional input channels (4 for the encoded masked-image 
    # # and 1 for the mask itself) whose weights were zero-initialized after restoring the 
    # # non-inpainting checkpoint.
    # logger.info("Initializing the XL Inpainting UNet from the pretrained UNet.")
    # in_channels = 9
